        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                                ...
                                <tbody>
                                    @foreach ($bookings as $booking)
                                        <tr>
                                            ...
                                            <td>{{ number_format($compute->computationDisplay($booking->start_date, $booking->end_date, $booking->price_per_day, $accessory, $booking->car_id), 2, '.', ',') }}DH
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <h3 class="m-0" style="text-align: right">Total: {{ number_format($totalPrice, 2, '.', ',') }}DH</h3>
                    <!-- /.card -->
                </div>
            </div>
        </div>
