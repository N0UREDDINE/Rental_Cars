...
@section('content')
    ...
    <div class="container" style="height: 80vh">
        <h1 style="padding-top: 2%">My Garage</h1>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <p class="card-text"><strong>Price:</strong>
                                                {{ number_format($carDetails->computationDisplay(null, null, $carDetails->CarDetails($bookInfo['car_id'])->price_per_day, $accessory, $bookInfo['car_id']), 0, '.', ',') }}DH
                                                per day
                                            </p>
                                        </div>
                                        <div class="col-md-8" style="text-align: right">
                                            <h4 class="card-text"><strong>Total Price:</strong>
                                                {{ number_format($carDetails->computationDisplay($bookInfo['start_date'], $bookInfo['end_date'], $carDetails->CarDetails($bookInfo['car_id'])->price_per_day, $accessory, $bookInfo['car_id']), 0, '.', ',') }}DH
                                            </h4>
                                        </div>
                                    </div>
